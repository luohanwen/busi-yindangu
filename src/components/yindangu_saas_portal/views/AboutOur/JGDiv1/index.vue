<template>
    ...
    <div class="ydg-page">
        <Layout>
            ...
            <content>
                <SubMenu @tabChange="tabChange" :navList="navList" :CarouselPage="CarouselPage"></SubMenu>
...
export default {
    ...
    computed: {
        compantList() {
            return (
                (this.OurInfonation[0] && this.OurInfonation[0].compantList) ||
                {}
            );
        },
        ourCustomer() {
            return (
                (this.OurInfonation[0] && this.OurInfonation[0].ourCustomer) ||
                {}
            );
        }
    },
